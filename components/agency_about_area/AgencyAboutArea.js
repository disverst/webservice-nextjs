...
export function AgencyAboutArea () {
    return (
        <>
            <section className="agency_about_area d-flex bg_color">
                <div className="col-lg-6 about_content_left ">
                    <div className="about_content mb_30">
                        <h2 className="f_size_30 f_700 l_height45 mb_20">We craft marketing & digital products that grow
                            businesses.</h2>
                        <p className="f_size_15 f_400 mb_40">Why I say old chap that is spiffing bodge, blag pardon me
                            buggered mufty Oxford butty bubble and squeak wind up, brown bread the full monty bloke
                            ...
                            <div className="about_item w55">
                                <img src="img/home4/team2.jpg" alt="" />
                                    <div className="about_text text_two">
                                        <span className="br" />
                                        <h5 className="f_size_18 l_height28 mb-0">Oxford butty bubble and squeak wind up, brown bread the full monty.
                                        </h5>
                                    </div>
                            </div>
                            <div className="about_item w55">
